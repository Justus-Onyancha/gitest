...
class TestCredential(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_credential = Credential("justus","visa","visa17")
    ...
    def test_init(self):
        ...
        '''
        self.assertEqual( self.new_credential.user_password, "justus")
        self.assertEqual( self.new_credential.credential_name, "visa" )
        self.assertEqual( self.new_credential.credential_password, "visa17" )
    ...
    def test_display_credential(self):
        ...
        test_credential = Credential("justus2","visa","visa17")

        test_credential.save_credential()
        
        self.assertEqual( len(Credential.display_credential("justus2")) , 2 )
