...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Create user object
        self.new_user = User("Justus","onyancha")
    ...
    def test_init(self):
        ...
        self.assertEqual( self.new_user.user_name, "Justus" )
        self.assertEqual( self.new_user.user_password, "onyancha" )
    ...
    def test_find_credential(self):
        ...
        found_credential = User.find_credential("visa")
